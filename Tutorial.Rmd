...
res_uw=MUSE(K=K,N=N,Z_names=Z_names,
...
res_pl= MUSE(K=K,N=N,Z_names=Z_names,intdata_list=intdata_list,IPW=TRUE,
...
res_cl=MUSE(K=K,N=N,Z_names=Z_names,intdata_list=intdata_list,IPW=TRUE,
            select_var_list=select_var_list,
...
res_aipw=MUSE(K=K,N=N,Z_names=Z_names,intdata_list=intdata_list,IPW=TRUE,
